...
public class DetalleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nombre=view.findViewById(R.id.detallenombre);
        descripcion=view.findViewById(R.id.detalledescripcion);
        ...
        if (bundle!=null){
            ...
            Picasso.with(getActivity()).load(Configuracion.servidor+"/"+sitio.getFoto()).into(imagen);
        }
        return view;
    }
